...
export const AboutUs = () => {
  ...
  return (
    <section className="py-32 max-md:px-5 min-h-screen max-lg:pt-5 max-lg:mt-20 relative w-full max-lg:h-auto">
  ...
  <div className="flex justify-between items-center px-5 h-full max-lg:block">
        ...
        <div className=" w-1/2 px-5 max-lg:w-10/12 max-md:w-full max-lg:mx-auto"><img src={`https://bakery.liara.run${about && about.image}`} alt="درباره ما" className=' rounded-2xl shadow-lg ' /></div>
   </div>
      </section>
  )
}
